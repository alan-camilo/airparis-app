...
abstract class BaseViewModel<CD : Coordinator, ST : State> : CoroutineScope,
     ...
     */
    protected val stateChannel: ConflatedBroadcastChannel<ST> =
        ConflatedBroadcastChannel(getInitialState())
    ...
    init {
        launch {
            // Immediately start listening for base.State changes.
...
/**
 * base.State interface implemented by each View.
 */
