...
import parisrespire.base.NOTIFICATION_SHARED_PREFERENCE
...
class NotificationSettingsModel {
    ...
    init {
        val pref = UserPreference.getLong(TIME_SHARED_PREFERENCE, 0L)
        ...
        isNotified = UserPreference.getBoolean(NOTIFICATION_SHARED_PREFERENCE, false)
        isAlerted = UserPreference.getBoolean(ALERT_SHARED_PREFERENCE, true)
    }
