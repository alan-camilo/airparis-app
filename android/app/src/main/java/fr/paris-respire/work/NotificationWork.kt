...
import fr.paris-respire.SHARED_PREFERENCES
import fr.paris-respire.activity.MainActivity
import fr.paris-respire.util.TIME_SHARED_PREFERENCE
import fr.paris-respire.util.indexToHumanReadableString
...
class NotificationWork(
    ...
    companion object {
        const val NOTIFICATION_ID = "paris-respire_notification_id"
        const val NOTIFICATION_CHANNEL_ID = "paris-respire_channel_01"
        const val NOTIFICATION_WORK = "paris-respire_notification_work"
    }
}
